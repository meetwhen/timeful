...
Scheduling code must not silently substitute datetime values or fake time sentinels for explicit civil-date and end-of-day semantics.
...
Scheduling-domain code makes its civil-date and end-of-day interpretation explicit at the boundary where it is modeled.
