...
- Event ownership makes an Event Owner an Event Guest with additional
  event-settings authority. The owner edit token is only an event-settings
  credential; response authority remains separate.
- A Platform Identity may recover event-management authority after the owner
  proves the owner edit token and associates the ownership. A raw Platform
...
and [FR-039](../../../requirements/functional/fr/FR-039.md). Event visitor and
platform identity association are defined by [FR-079](../../../requirements/functional/fr/FR-079.md);
owner recovery is defined by [FR-063](../../../requirements/functional/fr/FR-063.md).
