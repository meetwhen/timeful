...
| [FR-002](functional/fr/FR-002.md) | Project timed slots into their display-date columns              | frontend          |
...
| [FR-020](functional/fr/FR-020.md) | Keep the mobile selected-slot tooltip available after scrolling  | frontend          |
