...
| [FR-048](functional/fr/FR-048.md) | Center the no-response mobile [Show all hours](../terminology/glossary.md#show-all-hours-option) control                                                                                                                            | frontend          |
...
| [FR-070](functional/fr/FR-070.md) | Omit advertising when [Freemium Mode](../terminology/glossary.md#freemium-mode) is disabled                                                                                                                                         | frontend          |
| [FR-071](functional/fr/FR-071.md) | Remove advertising layout reservations when [Freemium Mode](../terminology/glossary.md#freemium-mode) is disabled                                                                                                                   | frontend          |
| [FR-072](functional/fr/FR-072.md) | Bypass [Freemium Mode](../terminology/glossary.md#freemium-mode) restrictions when **Freemium Mode** is disabled                                                                                                                    | frontend          |
...
| [FR-082](functional/fr/FR-082.md) | Transfer [Platform Sign-In](../terminology/glossary.md#platform-sign-in) from a PostgreSQL event to another browser                                                                                                                 | frontend, backend |
