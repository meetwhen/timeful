...
Existing requirements: [QR-009](../../quality/qr/QR-009.md) applies safe configuration validation to staging deployments, but does not establish staging's purpose, parity, access, or lifecycle.
