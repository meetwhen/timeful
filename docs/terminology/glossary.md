...
- [Timed-slot Terms](#timed-slot-terms)
  - [Event Kind](#event-kind)
  - [Timed Event](#timed-event)
  - [Timed Slot](#timed-slot)
  - [Instant](#instant)
  - [Civil Date](#civil-date)
  - [Slot Increment](#slot-increment)
  - [Dates-Only Event](#dates-only-event)
  - [Timed Domain Mode](#timed-domain-mode)
  - [Ranged Domain Mode](#ranged-domain-mode)
  - [Custom Domain Mode](#custom-domain-mode)
  - [Custom Domain Editing](#custom-domain-editing)
  - [Picked Dates](#picked-dates)
  - [Enabled Slots](#enabled-slots)
...
- [Response Access Terms](#response-access-terms)
  ...
  - [Availability Response Edit Credential](#availability-response-edit-credential)
  - [Cross-Device Access Transfer](#cross-device-access-transfer)
  - [Blind Availability](#blind-availability)
  - [Availability Response](#availability-response)
  - [Availability State](#availability-state)
    - [Available](#available)
    - [If needed](#if-needed)
    - [Unavailable](#unavailable)
  - [Availability Response Overlay](#availability-response-overlay)
  - [Protected Response](#protected-response)
  - [Open Response](#open-response)
  - [Shared Link](#shared-link)
- [Grid Rendering Terms](#grid-rendering-terms)
  - [Timed Grid](#timed-grid)
  - [Enabled Inactive Slot](#enabled-inactive-slot)
  - [Disabled Padding Cell](#disabled-padding-cell)
  - [Grid Pointer](#grid-pointer)
  - [Projected Date Column](#projected-date-column)
  - [Saved Active-Range Band](#saved-active-range-band)
  - [Event Scheduled Span](#event-scheduled-span)
  - [Timed Event Scheduled Span](#timed-event-scheduled-span)
  - [Dates-Only Event Scheduled Span](#dates-only-event-scheduled-span)
  - [Schedule Overlap](#schedule-overlap)
  - [Event Settings](#event-settings)
  - [Dates-Only Grid](#dates-only-grid)
  - [Disabled Status](#disabled-status)
- [Availability Editing Terms](#availability-editing-terms)
...
- [Product-Mode Terms](#product-mode-terms)
  - [Freemium](#freemium)
- [UI Elements](#ui-elements)
  - [Legend](#legend)
  - [Show all hours](#show-all-hours)
