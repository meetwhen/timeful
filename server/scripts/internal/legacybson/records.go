...
// outer storage key that encoded the signed-in user identity. It is the
// BSON-aware helper the retained backfills need; runtime code uses the
// canonical models.ID equivalent.
